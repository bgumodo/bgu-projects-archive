...
class RoomScanner:
    debug_level = 1
    camera_horizontal_arc = 60 #58  # Asus Xiton Pro Live has a 58deg horizontal angle
    rotation_target = 0
    ...
    def __init__(self):
        ...
        self.scan_publisher = rospy.Publisher("/cupinator/room_scanner/result", RoomScannerResult, queue_size=2)
    ...
    def publish_scan_result(self, match_cost, matched_contour, match_frame, match_frame_idx=0):
        ...
        self.scan_publisher.publish(scan_result)
